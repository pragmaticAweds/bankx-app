...
const Hero = () => {
  return (
    <StyledHero>
      ...
      />
      <div className="z-10 flex flex-col justify-center items-center h-full gap-y-2 max-w-2xl mx-auto text-center">
        ...
        <p className="text-gray-300">
          ...
          latest techniques and tools to give you the perfect look. Whether
          you&apos;re in need of a classic haircut, straight razor shave, or
